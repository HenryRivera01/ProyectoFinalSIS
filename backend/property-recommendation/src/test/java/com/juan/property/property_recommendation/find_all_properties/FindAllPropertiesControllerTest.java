...
public class FindAllPropertiesControllerTest {
    @Autowired
    ...
    @Test
    public void testFindAllPropertiesTest() throws Exception {
    ...
    @Test
    public void testFilterPropertiesTest() throws Exception {
        PropertySpecification spec = new  PropertySpecification();
